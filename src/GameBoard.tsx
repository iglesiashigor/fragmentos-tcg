              ...
              {selectionMode === 'none' && isMainPhase && (
                <>
                  <button
                    ...
                    className="px-5 py-2 bg-gradient-to-r from-rose-700 to-rose-600 hover:from-rose-600 hover:to-rose-500 disabled:from-slate-800 disabled:to-slate-800 disabled:text-slate-500 text-white text-sm rounded-lg font-bold transition-all flex items-center gap-2 shadow-lg shadow-rose-900/30 disabled:shadow-none disabled:cursor-not-allowed"
